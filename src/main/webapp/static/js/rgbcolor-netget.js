...
function trackDrag(node, handler) {
    function fixCoords(x, y) {
        var nodePageCoords = pageCoordsExt(node);
...
function pageCoordsExt(node) {
    var x = node.offsetLeft;
    var y = node.offsetTop;
    var yScroll = node.scrollTop;
    ...
    var scrollTop = document.getElementById("event_form").scrollTop;
...
function makeColorSelectors(ev) {
    var node = document.getElementById("background.color.temp");
