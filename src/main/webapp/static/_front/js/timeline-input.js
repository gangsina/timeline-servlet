...
function _set_value(obj,_field_name,_input_name) {
    ...
    var descriptor = Object.create(null);
    descriptor.value = $("input[name='" + _input_name + "']").val();
    if (descriptor.value) {
        descriptor.writable = true;
        Object.defineProperty(obj, _field_name, descriptor);
    } else{
        assertConsole("pass !!  descriptor.writable is " + descriptor.writable);
    }
...
function _set_value_sub(obj,_field_name,_sub_field_names) {
    ...
    // if(hasPropertiy(_field_name)){
    //     _fieldDes = Object.getOwnPropertyDescriptor(obj,_field_name);
    // }else{
    //     _fieldDes = Object.create(null)
    //     _fieldDes.writable = true;
    // }
