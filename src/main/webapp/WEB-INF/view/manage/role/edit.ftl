 ...
 <div class="xzjs xzjs1">
  ...
  <input type="hidden" name="id" value="${role.id}">
   <table>
       <tr>
          ...
          <td ><input type="text" name="roleName" id="roleName" value="${role.roleName}"  class="put validate[required,maxSize[50]]" style="width:150px"/>
          </td>
       </tr>
        <tr>
          <td class="name"><strong>* </strong>排序：</td>
          <td ><input type="text" name="sortOrder" id="sortOrder" value="${role.sortOrder}"  class="put validate[required,maxSize[5],custom[integer]]" style="width:150px"/>
          </td>
       </tr>
       <tr>
          <td class="name" valign="top" style="line-height:28px">职位描述：</td>
          <td>
              <textarea name="memo" id="memo" class="validate[maxSize[200]]">${role.memo}</textarea>
          </td>
       </tr>
       <tr>
  ...
  <div class="buttom"><button type="button" onclick="updateRole(${role.id});" class="but1">提交</button><button type="button" onclick="$.unblockUI();" class="but2" >取消</button></div>
 </div>
